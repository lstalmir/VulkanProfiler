 ...
 ******************************************************************************/
    ...
    typedef struct NVPW_D3D12_Profiler_IsGpuSupported_Params
    {
        ...
        /// [out]
        NVPW_SkuSupportLevel skuSupportLevel;
    } NVPW_D3D12_Profiler_IsGpuSupported_Params;
#define NVPW_D3D12_Profiler_IsGpuSupported_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_D3D12_Profiler_IsGpuSupported_Params, skuSupportLevel)
...
#define NVPW_D3D12_MiniTrace_IsGpuSupported_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_D3D12_MiniTrace_IsGpuSupported_Params, skuSupportLevel)
