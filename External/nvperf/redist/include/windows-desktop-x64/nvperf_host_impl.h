...
typedef NVPA_Status (*NVPW_Device_GetUUID_Fn)(NVPW_Device_GetUUID_Params* pParams);
...
static NVPA_Status NVPW_Device_GetUUID_Default(NVPW_Device_GetUUID_Params* pParams)
{
    (void)pParams;
    return g_defaultStatus;
}
...
typedef struct NvPerfApi {
    ...
    NVPW_Device_GetUUID_Fn                                       NVPW_Device_GetUUID;
...
static void InitNvPerfProcs(void)
{
    ...
    g_api.fn.NVPW_Device_GetUUID = (NVPW_Device_GetUUID_Fn)GetNvPerfProc("NVPW_Device_GetUUID", (NVPA_GenericFn)g_api.fn.NVPW_Device_GetUUID);
...
{
    return g_api.fn.NVPW_Device_GetUUID(pParams);
}
