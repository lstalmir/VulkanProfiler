...
#define NVPW_VK_Profiler_IsGpuSupported_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_VK_Profiler_IsGpuSupported_Params, skuSupportLevel)
...
#define NVPW_VK_MiniTrace_IsGpuSupported_Params_STRUCT_SIZE NVPA_STRUCT_SIZE(NVPW_VK_MiniTrace_IsGpuSupported_Params, skuSupportLevel)
